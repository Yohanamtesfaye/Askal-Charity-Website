    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold text-green-600 mb-3">{t("our_gallery")}</h2>
            ...
            >
              ...
              >
                ...
                <div className="p-4 bg-white">
                  <h3 className="text-lg font-semibold text-green-600 mb-2">{t("description")}</h3>
                  <p className="text-gray-700 text-sm">{selectedMedia.alt}</p>
                  <button
                    onClick={() => setSelectedMedia(null)}
                    className="absolute top-3 right-3 bg-white/90 hover:bg-white text-gray-800 rounded-full p-2 transition-colors duration-200"
                  >
